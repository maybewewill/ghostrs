...
pub struct Config {
    ...
    pub db_path: PathBuf,
    pub maps: HashMap<String, spectre_engine::MapOverride>,
}
...
impl From<TomlMapOverride> for spectre_engine::MapOverride {
...
impl Config {
    ...
    pub fn parse(s: &str) -> anyhow::Result<Self> {
        ...
        let db_path = map
            .get("db_path")
            .map(PathBuf::from)
            .unwrap_or_else(|| PathBuf::from("spectre.db"));
        ...
        Ok(Config {
            ...
            game: GameDefaults {
                ...
                virtual_host_name: map
                    ...
                    .cloned()
                    .unwrap_or_else(|| "|cFF4080C0Spectre".into()),
